...
func (_c *GroupCreate) AddUserGroupIDs(ids ...uuid.UUID) *GroupCreate {
	_c.mutation.AddUserGroupIDs(ids...)
	return _c
}

// AddUserGroups adds the "user_groups" edges to the UserGroup entity.
func (_c *GroupCreate) AddUserGroups(v ...*UserGroup) *GroupCreate {
...
func (_c *GroupCreate) AddDocumentACLIDs(ids ...uuid.UUID) *GroupCreate {
	_c.mutation.AddDocumentACLIDs(ids...)
	return _c
}

// AddDocumentAcls adds the "document_acls" edges to the DocumentACL entity.
func (_c *GroupCreate) AddDocumentAcls(v ...*DocumentACL) *GroupCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddDocumentACLIDs(ids...)
}
...
func (_c *GroupCreate) createSpec() (*Group, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.DocumentAclsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
