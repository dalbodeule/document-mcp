...
type DocumentQuery struct {
	...
	withAliases   *DocumentAliasQuery
	withEmbedding *DocumentEmbeddingQuery
	withAcls      *DocumentACLQuery
...
func (_q *DocumentQuery) QueryAliases() *DocumentAliasQuery {
	query := (&DocumentAliasClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *DocumentQuery) QueryEmbedding() *DocumentEmbeddingQuery {
	query := (&DocumentEmbeddingClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryAcls chains the current query on the "acls" edge.
func (_q *DocumentQuery) QueryAcls() *DocumentACLQuery {
	query := (&DocumentACLClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *DocumentQuery) Clone() *DocumentQuery {
	...
	return &DocumentQuery{
		...
		withEmbedding: _q.withEmbedding.Clone(),
		withAcls:      _q.withAcls.Clone(),
...
func (_q *DocumentQuery) WithAliases(opts ...func(*DocumentAliasQuery)) *DocumentQuery {
	query := (&DocumentAliasClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *DocumentQuery) WithEmbedding(opts ...func(*DocumentEmbeddingQuery)) *DocumentQuery {
	query := (&DocumentEmbeddingClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withEmbedding = query
	return _q
}

// WithAcls tells the query-builder to eager-load the nodes that are connected to
// the "acls" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *DocumentQuery) WithAcls(opts ...func(*DocumentACLQuery)) *DocumentQuery {
	query := (&DocumentACLClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *DocumentQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Document, error) {
	...
	if query := _q.withAliases; query != nil {
		if err := _q.loadAliases(ctx, query, nodes,
			func(n *Document) { n.Edges.Aliases = []*DocumentAlias{} },
			func(n *Document, e *DocumentAlias) { n.Edges.Aliases = append(n.Edges.Aliases, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withEmbedding; query != nil {
		if err := _q.loadEmbedding(ctx, query, nodes, nil,
			func(n *Document, e *DocumentEmbedding) { n.Edges.Embedding = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withAcls; query != nil {
		if err := _q.loadAcls(ctx, query, nodes,
			func(n *Document) { n.Edges.Acls = []*DocumentACL{} },
			func(n *Document, e *DocumentACL) { n.Edges.Acls = append(n.Edges.Acls, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *DocumentQuery) loadAliases(ctx context.Context, query *DocumentAliasQuery, nodes []*Document, init func(*Document), assign func(*Document, *DocumentAlias)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(documentalias.FieldDocumentID)
	}
	query.Where(predicate.DocumentAlias(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(document.AliasesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *DocumentQuery) loadEmbedding(ctx context.Context, query *DocumentEmbeddingQuery, nodes []*Document, init func(*Document), assign func(*Document, *DocumentEmbedding)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Document)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(documentembedding.FieldDocumentID)
	}
	query.Where(predicate.DocumentEmbedding(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(document.EmbeddingColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *DocumentQuery) loadAcls(ctx context.Context, query *DocumentACLQuery, nodes []*Document, init func(*Document), assign func(*Document, *DocumentACL)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Document)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(documentacl.FieldDocumentID)
	}
	query.Where(predicate.DocumentACL(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(document.AclsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *DocumentQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withCreatedBy != nil {
			_spec.Node.AddColumnOnce(document.FieldCreatedByUserID)
		}
	}
