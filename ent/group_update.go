...
func (_u *GroupUpdate) AddUserGroupIDs(ids ...uuid.UUID) *GroupUpdate {
	_u.mutation.AddUserGroupIDs(ids...)
	return _u
}

// AddUserGroups adds the "user_groups" edges to the UserGroup entity.
func (_u *GroupUpdate) AddUserGroups(v ...*UserGroup) *GroupUpdate {
...
func (_u *GroupUpdate) AddDocumentACLIDs(ids ...uuid.UUID) *GroupUpdate {
	_u.mutation.AddDocumentACLIDs(ids...)
	return _u
}

// AddDocumentAcls adds the "document_acls" edges to the DocumentACL entity.
func (_u *GroupUpdate) AddDocumentAcls(v ...*DocumentACL) *GroupUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddDocumentACLIDs(ids...)
}
...
// ClearDocumentAcls clears all "document_acls" edges to the DocumentACL entity.
func (_u *GroupUpdate) ClearDocumentAcls() *GroupUpdate {
	_u.mutation.ClearDocumentAcls()
	return _u
}

// RemoveDocumentACLIDs removes the "document_acls" edge to DocumentACL entities by IDs.
func (_u *GroupUpdate) RemoveDocumentACLIDs(ids ...uuid.UUID) *GroupUpdate {
	_u.mutation.RemoveDocumentACLIDs(ids...)
	return _u
}

// RemoveDocumentAcls removes "document_acls" edges to DocumentACL entities.
func (_u *GroupUpdate) RemoveDocumentAcls(v ...*DocumentACL) *GroupUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveDocumentACLIDs(ids...)
}
...
func (_u *GroupUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.DocumentAclsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   group.DocumentAclsTable,
			Columns: []string{group.DocumentAclsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if nodes := _u.mutation.RemovedDocumentAclsIDs(); len(nodes) > 0 && !_u.mutation.DocumentAclsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   group.DocumentAclsTable,
	...
	if nodes := _u.mutation.DocumentAclsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   group.DocumentAclsTable,
...
// AddUserGroupIDs adds the "user_groups" edge to the UserGroup entity by IDs.
func (_u *GroupUpdateOne) AddUserGroupIDs(ids ...uuid.UUID) *GroupUpdateOne {
	_u.mutation.AddUserGroupIDs(ids...)
	return _u
}

// AddUserGroups adds the "user_groups" edges to the UserGroup entity.
func (_u *GroupUpdateOne) AddUserGroups(v ...*UserGroup) *GroupUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddDocumentACLIDs adds the "document_acls" edge to the DocumentACL entity by IDs.
func (_u *GroupUpdateOne) AddDocumentACLIDs(ids ...uuid.UUID) *GroupUpdateOne {
	_u.mutation.AddDocumentACLIDs(ids...)
	return _u
}

// AddDocumentAcls adds the "document_acls" edges to the DocumentACL entity.
func (_u *GroupUpdateOne) AddDocumentAcls(v ...*DocumentACL) *GroupUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearUserGroups clears all "user_groups" edges to the UserGroup entity.
func (_u *GroupUpdateOne) ClearUserGroups() *GroupUpdateOne {
	_u.mutation.ClearUserGroups()
	return _u
}

// RemoveUserGroupIDs removes the "user_groups" edge to UserGroup entities by IDs.
func (_u *GroupUpdateOne) RemoveUserGroupIDs(ids ...uuid.UUID) *GroupUpdateOne {
	_u.mutation.RemoveUserGroupIDs(ids...)
	return _u
}

// RemoveUserGroups removes "user_groups" edges to UserGroup entities.
func (_u *GroupUpdateOne) RemoveUserGroups(v ...*UserGroup) *GroupUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearDocumentAcls clears all "document_acls" edges to the DocumentACL entity.
func (_u *GroupUpdateOne) ClearDocumentAcls() *GroupUpdateOne {
	_u.mutation.ClearDocumentAcls()
	return _u
}

// RemoveDocumentACLIDs removes the "document_acls" edge to DocumentACL entities by IDs.
func (_u *GroupUpdateOne) RemoveDocumentACLIDs(ids ...uuid.UUID) *GroupUpdateOne {
	_u.mutation.RemoveDocumentACLIDs(ids...)
	return _u
}

// RemoveDocumentAcls removes "document_acls" edges to DocumentACL entities.
func (_u *GroupUpdateOne) RemoveDocumentAcls(v ...*DocumentACL) *GroupUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
