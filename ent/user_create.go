...
func (_c *UserCreate) AddUserGroupIDs(ids ...uuid.UUID) *UserCreate {
...
func (_c *UserCreate) AddDocumentsCreatedIDs(ids ...uuid.UUID) *UserCreate {
	_c.mutation.AddDocumentsCreatedIDs(ids...)
	return _c
}

// AddDocumentsCreated adds the "documents_created" edges to the Document entity.
func (_c *UserCreate) AddDocumentsCreated(v ...*Document) *UserCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddDocumentsCreatedIDs(ids...)
}
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.DocumentsCreatedIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
