...
type UserEdges struct {
	...
	// DocumentsCreated holds the value of the documents_created edge.
	DocumentsCreated []*Document `json:"documents_created,omitempty"`
...
// DocumentsCreatedOrErr returns the DocumentsCreated value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) DocumentsCreatedOrErr() ([]*Document, error) {
	if e.loadedTypes[1] {
		return e.DocumentsCreated, nil
	}
	return nil, &NotLoadedError{edge: "documents_created"}
}
...
// QueryDocumentsCreated queries the "documents_created" edge of the User entity.
func (_m *User) QueryDocumentsCreated() *DocumentQuery {
	return NewUserClient(_m.config).QueryDocumentsCreated(_m)
}
