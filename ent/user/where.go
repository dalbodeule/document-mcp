...
// HasDocumentsCreated applies the HasEdge predicate on the "documents_created" edge.
func HasDocumentsCreated() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasDocumentsCreatedWith applies the HasEdge predicate on the "documents_created" edge with a given conditions (other predicates).
func HasDocumentsCreatedWith(preds ...predicate.Document) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newDocumentsCreatedStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
